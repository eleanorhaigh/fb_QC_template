...
```{r netCDF}
load("C:\\Users\\EH08\\Documents\\June 19\\juneferrrybox\\checking scripts\\2012-copy\\2012QA3_complete.rdata")
library(ncdf4)
library(oce)
...
traj_dim=ncdim_def("trajectory", "", 1, longname="Cefas Endeavour Ferrybox Data 2012")
...
new_nc=nc_create("Fb2012.nc", test_list)
